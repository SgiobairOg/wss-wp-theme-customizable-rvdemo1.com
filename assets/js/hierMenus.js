...
function popMenu(e){
    ...
    //AJH
    if (currentMenu.fullHeight > 50)
    {
        hide_select_dropdown(); //AJH
    }
...
function hide_select_dropdown()
{
    ...
    for(i=1; i<topCount; i++) {
        temp = eval("elMenu" + i + ".startChild");
        if (NS4) {
            if (temp.visibility == "show") blnDoit = true;
        }
        else {
            if (temp.style.visibility == "visible") blnDoit = true;
        }
    }
    ...
    if (NS4)
    {
        if (document.layers["dropdown"] != null)
        {
            document.layers["dropdown"].visibility='hide';
        }
    }
    else
    {
        ...
        {
            tmpLayer = document.all[i];
            if ( tmpLayer.id.substring(0,8) == "dropdown" )
            {
...
function show_select_dropdown()
{
    ...
    for(i=1; i<topCount; i++) {
        temp = eval("elMenu" + i + ".startChild");
        if (NS4) {
            if (temp.visibility == "show") theHeight = temp.fullHeight;
        }
        else {
            if (temp.style.visibility == "visible") theHeight = temp.fullHeight;
        }
    }

    if (theHeight > 50) return;
    ...
    if (NS4)
    {
        if (document.layers["dropdown"] != null)
        {
            document.layers["dropdown"].visibility='visible';
        }
    }
    else
    {
